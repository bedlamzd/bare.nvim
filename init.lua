...
end, { desc = '[T]oggle showing [d]iagnostic messages' })
...
require('lazy').setup({
  ...
  -- TODO: Annoys me, replace it with something
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [F]iles everywhere' })
      ...
      end, { desc = '[S]earch by [G]rep everywhere' })
      vim.keymap.set('n', '<leader>sd', builtin.diagnostics, { desc = '[S]earch [D]iagnostics' })
      vim.keymap.set('n', '<leader>dd', function()
        return builtin.diagnostics { bufnr = 0 }
      end, { desc = '[S]earch this [d]ocument [d]iagnostics' })
